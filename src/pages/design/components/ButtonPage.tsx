              ...
              <Card className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="space-y-2">
                    ...
                    <Select value={playgroundVariant} onValueChange={(value: any) => setPlaygroundVariant(value)}>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={playgroundSize} onValueChange={(value: any) => setPlaygroundSize(value)}>
